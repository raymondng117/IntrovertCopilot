...
// based on the character being selected to generate spark
const gridCards = document.querySelectorAll('.grid_card');
  ...
  function getResponse(message) {
    ...
    fetch("https://wise-adder-loyal.ngrok-free.app/introvertcopilot", {
      method: 'POST',
      headers: {
  ...
  // Attach the event listener to each grid_card element
